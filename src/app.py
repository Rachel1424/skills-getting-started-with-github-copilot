...
activities = {
    ...
    "Soccer Team": {
        ...
        "max_participants": 22,
        "participants": ["captain@mergington.edu", "alex@mergington.edu"]
    },
    "Basketball Club": {
    ...
    "Photography Club": {
        "description": "Learn photography techniques and create photo exhibits",
    ...
    "Robotics Club": {
        ...
        "max_participants": 16,
        "participants": ["toni@mergington.edu"]
    }
}
